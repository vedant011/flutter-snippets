...
class HomeState extends State<Home> {
  ...
  void openFileExplorer() async {
    try {
      ...
      _path = (await FilePicker.platform.pickFiles(
          ...
          allowedExtensions: ['png', 'jpg', 'pdf', 'docx', 'mp3', 'mp4']));
      print("Path: $_path");
      uploadToFirebase();
  ...
  uploadToFirebase() {
    FilePickerResult fileName = _path;
    FilePickerResult filePath = _path;
  ...
  upload(fileName, filePath) {
    ...
    if (_extension == 'png' || _extension == 'jpg') {
      final StorageUploadTask uploadTask =
          storageRef.child("Images/$fileName").putFile(
                File(filePath),
                StorageMetadata(
                  contentType: '$_pickType/$_extension',
                ),
      ...
      final StorageUploadTask uploadTask =
          storageRef.child("Audio$fileName").putFile(
                File(filePath),
                StorageMetadata(
                  contentType: '$_pickType/$_extension',
                ),
